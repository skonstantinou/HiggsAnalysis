...
public:
  ...
  std::vector<std::string> getDiscriminatorNames() const {
    static std::vector<std::string> n = { std::string("Flag_BadChargedCandidateFilter"), std::string("Flag_BadPFMuonFilter"), std::string("Flag_CSCTightHaloFilter"), std::string("Flag_EcalDeadCellTriggerPrimitiveFilter"), std::string("Flag_HBHENoiseFilter"), std::string("Flag_HBHENoiseIsoFilter"), std::string("Flag_eeBadScFilter"), std::string("Flag_globalSuperTightHalo2016Filter"), std::string("Flag_goodVertices"), std::string("ecalBadCalibFilter"), std::string("hbheIsoNoiseToken"), std::string("hbheNoiseTokenRun2Loose"), std::string("hbheNoiseTokenRun2Tight") };
    return n;
  }

  std::vector<std::function<bool()>> getDiscriminatorValues() const {
    static std::vector<std::function<bool()>> values = {
      [&](){ return this->passFlag_BadChargedCandidateFilter(); },
      [&](){ return this->passFlag_BadPFMuonFilter(); },
      ...
      [&](){ return this->passFlag_globalSuperTightHalo2016Filter(); },
      [&](){ return this->passFlag_goodVertices(); },
      [&](){ return this->passEcalBadCalibFilter(); },
  ...
  bool passFlag_BadChargedCandidateFilter() const { return fFlag_BadChargedCandidateFilter->value(); }
  bool passFlag_BadPFMuonFilter() const { return fFlag_BadPFMuonFilter->value(); }
  ...
  bool passFlag_globalSuperTightHalo2016Filter() const { return fFlag_globalSuperTightHalo2016Filter->value(); }
  bool passFlag_goodVertices() const { return fFlag_goodVertices->value(); }
  bool passEcalBadCalibFilter() const { return fEcalBadCalibFilter->value(); }
...
protected:
  const Branch<bool> *fFlag_BadChargedCandidateFilter;
  const Branch<bool> *fFlag_BadPFMuonFilter;
  ...
  const Branch<bool> *fFlag_globalSuperTightHalo2016Filter;
  const Branch<bool> *fFlag_goodVertices;
  const Branch<bool> *fEcalBadCalibFilter;
