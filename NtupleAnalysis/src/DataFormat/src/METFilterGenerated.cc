...
void METFilterGenerated::setupBranches(BranchManager& mgr) {
  mgr.book("METFilter_Flag_BadChargedCandidateFilter", &fFlag_BadChargedCandidateFilter);
  mgr.book("METFilter_Flag_BadPFMuonFilter", &fFlag_BadPFMuonFilter);
  ...
  mgr.book("METFilter_ecalBadCalibFilter", &fEcalBadCalibFilter);
